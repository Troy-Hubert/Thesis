...
The following figure shows the number of veterans in each physical activity level based upon each health condition.
```{r}
#create cross tab of having condition
  AD_xtab <- xtabs(Any_Disability~Ex_3cat,data = thesis_NHRVS)
  xtable  <- rbind(AD_xtab,xtabs(Athsma~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Arthritis~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Cancer~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Chron_pain~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Liv_dis~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Diabetes~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Hrt_dis~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Hrt_atk~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(High_chol~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(High_bld_press~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Kid_dis~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Migrane~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(MS~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Osteoporosis~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Rhum_arth~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(Stroke~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(LT_AUD~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(LT_DUD~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(LT_MDD~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(LT_PTSD~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(LT_NicotineDep~Ex_3cat,data = thesis_NHRVS))
  xtable  <- rbind(xtable,xtabs(~LT_Suicidal +Ex_3cat,data = thesis_NHRVS)[2,])
  xtable  <- rbind(xtable,xtabs(No_Condition~Ex_3cat,data = thesis_NHRVS))
xtable<-data.frame(xtable)


#create cross tab of not having condition

  AD_xtab3 <- xtabs(~Any_Disability +Ex_3cat,data = thesis_NHRVS)[1,]
  xtable3  <- rbind(AD_xtab3,xtabs(~Athsma+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Arthritis+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Cancer+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Chron_pain+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Liv_dis+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Diabetes+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Hrt_dis+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Hrt_atk+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~High_chol+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~High_bld_press+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Kid_dis+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Migrane+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~MS+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Osteoporosis+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Rhum_arth+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~Stroke+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~LT_AUD+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~LT_DUD+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~LT_MDD+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~LT_PTSD+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~LT_NicotineDep+Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~LT_Suicidal +Ex_3cat,data = thesis_NHRVS)[1,])
  xtable3  <- rbind(xtable3,xtabs(~No_Condition+Ex_3cat,data = thesis_NHRVS)[1,])
xtable3<-data.frame(xtable3)
xtable3
```
...
#3. make data frame
 #3.1 wide dataframe (tidy data)
  var_num <- data.frame(cbind(var_names,
                              Insufficient = xtable$Insufficient,
                              Moderate = xtable$Moderate,
                              Sufficient = xtable$Active))
  
  #3.2 long data (needed for plot)
      condition_df          <- var_names
      condition_df <- data.frame(condition_df) 
      condition_df[1:24,1]  <- var_names              
      condition_df[25:48,1] <- var_names
      condition_df[49:72,1] <- var_names
      condition_df[1:24,2]  <- xtable$Insufficient
      condition_df[1:24,3]  =  "Insufficient"
      condition_df[25:48,2] <- xtable$Moderate
      condition_df[25:48,3] <- "Moderate"
      condition_df[49:72,2] <- xtable$Active
      condition_df[49:72,3] =  "Sufficient"
      condition_df
      names(condition_df) <- c("Variable","Value","Ex_3cat")
      condition_df
      ...
      #no conditions 
      condition_df3          <- var_names
      condition_df3 <- data.frame(condition_df3) 
      condition_df3[1:24,1]  <- var_names              
      condition_df3[25:48,1] <- var_names
      condition_df3[49:72,1] <- var_names
      condition_df3[1:24,2]  <- xtable3$Insufficient
      condition_df3[1:24,3]  =  "Insufficient"
      condition_df3[25:48,2] <- xtable3$Moderate
      condition_df3[25:48,3] <- "Moderate"
      condition_df3[49:72,2] <- xtable3$Active
      condition_df3[49:72,3] =  "Sufficient"
      condition_df3
      names(condition_df3) <- c("Variable","Value","Ex_3cat")
      condition_df3
...
library(ggplot2)
# con
ggplot(condition_df, aes(fill=Ex_3cat, y=Value, x= fct_reorder(Variable, Value))) + 
  geom_bar(position="stack", stat="identity")+
  ylab('Number of Veterans') +
  xlab('Health Condition')+
  ggtitle("Health Condition")+
...
#no con
ggplot(condition_df3, aes(fill=Ex_3cat, y=Value, x= fct_reorder(Variable, desc(Value)))) + 
  geom_bar(position="stack", stat="identity")+
  ylab('Number of Veterans') +
  xlab('Health Condition')+
  labs(fill='Physical Activity') +
  ggtitle("No Health Condition") +
  ylim(0,4000)+
  theme_classic()+
  theme(legend.position="none",
...
```{r}
  ...
  AD_chi   <-  summary(xtabs(~Any_Disability +Ex_3cat,data = thesis_NHRVS))
  chi_tab  = cbind(AD_chi[[3]],AD_chi[[6]])
  ATH_chi  <- summary(xtabs(~Athsma+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(ATH_chi[[3]],ATH_chi[[6]]))
  Arth_chi <- summary(xtabs(~Arthritis+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(Arth_chi[[3]],Arth_chi[[6]]))
  can_chi  <- summary(xtabs(~Cancer+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(can_chi[[3]],can_chi[[6]]))
  CP_chi   <- summary(xtabs(~Chron_pain+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(CP_chi[[3]],CP_chi[[6]]))
  Liv_dis_chi   <- summary(xtabs(~Liv_dis+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(Liv_dis_chi[[3]],Liv_dis_chi[[6]]))
  Diabetes_chi   <- summary(xtabs(~Diabetes+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(Diabetes_chi[[3]],Diabetes_chi[[6]]))
  Hrt_dis_chi   <- summary(xtabs(~Hrt_dis+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(Hrt_dis_chi[[3]],Hrt_dis_chi[[6]]))
  Hrt_atk_chi   <- summary(xtabs(~Hrt_atk+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(Hrt_atk_chi[[3]],Hrt_atk_chi[[6]]))
  High_chol_chi   <- summary(xtabs(~High_chol+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(High_chol_chi[[3]],High_chol_chi[[6]])) 
  High_bld_press_chi   <- summary(xtabs(~High_bld_press+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(High_bld_press_chi[[3]],High_bld_press_chi[[6]]))
  Kid_dis_chi   <- summary(xtabs(~Kid_dis+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(Kid_dis_chi[[3]],Kid_dis_chi[[6]]))
  Migrane_chi   <- summary(xtabs(~Migrane+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(Migrane_chi[[3]],Migrane_chi[[6]]))
  MS_chi   <- summary(xtabs(~MS+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(MS_chi[[3]],MS_chi[[6]]))
  Osteoporosis_chi   <- summary(xtabs(~Osteoporosis+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(Osteoporosis_chi[[3]],Osteoporosis_chi[[6]]))
  Rhum_arth_chi   <- summary(xtabs(~Rhum_arth+Ex_3cat,data = thesis_NHRVS))
  chi_tab  <- rbind(chi_tab,cbind(Rhum_arth_chi[[3]],Rhum_arth_chi[[6]]))
  Stroke_chi   <- summary(xtabs(~Stroke+Ex_3cat,data = thesis_NHRVS)) 
  chi_tab  <- rbind(chi_tab,cbind(Stroke_chi[[3]],Stroke_chi[[6]]))
  LT_AUD_chi   <- summary(xtabs(~LT_AUD+Ex_3cat,data = thesis_NHRVS)) 
  chi_tab  <- rbind(chi_tab,cbind(LT_AUD_chi[[3]],LT_AUD_chi[[6]]))
  LT_DUD_chi   <- summary(xtabs(~LT_DUD+Ex_3cat,data = thesis_NHRVS)) 
  chi_tab  <- rbind(chi_tab,cbind(LT_DUD_chi[[3]],LT_DUD_chi[[6]]))
  LT_MDD_chi   <- summary(xtabs(~LT_MDD+Ex_3cat,data = thesis_NHRVS)) 
  chi_tab  <- rbind(chi_tab,cbind(LT_MDD_chi[[3]],LT_MDD_chi[[6]]))
  LT_PTSD_chi   <- summary(xtabs(~LT_MDD+Ex_3cat,data = thesis_NHRVS)) 
  chi_tab  <- rbind(chi_tab,cbind(LT_MDD_chi[[3]],LT_MDD_chi[[6]]))
  LT_NicotineDep_chi   <- summary(xtabs(~LT_NicotineDep+Ex_3cat,data = thesis_NHRVS)) 
  chi_tab  <- rbind(chi_tab,cbind(LT_NicotineDep_chi[[3]],LT_NicotineDep_chi[[6]]))
  LT_Suicidal_chi   <- summary(xtabs(~LT_Suicidal+Ex_3cat,data = thesis_NHRVS)) 
  chi_tab  <- rbind(chi_tab,cbind(LT_Suicidal_chi[[3]],LT_Suicidal_chi[[6]]))
  No_Condition_chi   <- summary(xtabs(~No_Condition+Ex_3cat,data = thesis_NHRVS)) 
  chi_tab  <- rbind(chi_tab,cbind(No_Condition_chi[[3]],No_Condition_chi[[6]]))
chi_tab<-data.frame(chi_tab)
chi_tab <- cbind(var_names,chi_tab)
names(chi_tab) <- c("Variable","Chi.Sq","p.value")
chi_tab

write.csv(chi_tab,"~/Desktop/Coding/data/thesis_con_chi.csv")
# gg_chi_tab <- chi_tab |>
#       ggplot() +
#         geom_text(aes(x = 0, y = Variable, label = Chi.Sq), hjust = 0,
#         fontface = ifelse(chi_tab$p.value == "p-value", "bold", "plain")) +
#         theme_void() +
...
ggplot(condition_df2, aes(fill=Ex_3cat, y=Value, x= fct_reorder(Variable, Value))) + 
  geom_bar(position="stack", stat="identity")+
  facet_grid(~ Diagnosis)+ #fct_reorder(as.factor(Diagnosis), desc(Diagnosis)))+
  ylab('Number of Veterans') +
  xlab('Health Condition')+
  labs(fill='Physical Activity') +
  ggitle("No Condition")
