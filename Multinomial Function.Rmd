...
This runs the regressions without covariates. These regressions allow us to see how health conditions area associated with physical activity levels independent of covariates. 
```{r}
...
This runs the regressions with covariates
```{r}
#multinomial function
...
# Block 2:  MCS / PCS 
  #MCS
    R2CHANGE  <- rbind(R2CHANGE,NA,((r2(Cov.MCS_Reg)[[1]] - r2(Cov_Reg)[[1]])*100))
  #PCS
    R2CHANGE  <-rbind(R2CHANGE,NA,((r2(Cov.PCS_Reg)[[1]] - r2(Cov_Reg)[[1]])*100))
...
```{r}
#1. Seperate R2 change by helath conditions
R2_Conditions<- R2CHANGE[10:32,]
